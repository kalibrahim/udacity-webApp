...
var trace1 = {
  ...
  x: [country_name_brazil, country_name_china, country_name_germany],
  y: [arable_land_brazil[0], arable_land_china[0], arable_land_germany[0]],
  type: 'bar'
};

var layout = {
  /* TODO: include a title for the chart */
  title: "Arable land for each country for 2015",
  xaxis: {
      title: 'Country',
  },
  yaxis: {
    title: 'Hectars per perspm'
  }
};
